...
public class MapsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Double latitud = intent.getDoubleExtra("lat",1);
        Double longitud = intent.getDoubleExtra("lon",1);
        String descripción = intent.getStringExtra("descripcion");
        TextView tvDesc = (TextView)findViewById(R.id.tvDescMap);
        tvDesc.setText(descripción);
